...
class Environment(object):
    ...
    # Introducing and Initialising all the parameters and variables of the Environment
    ...
    def update_env(self, direction, energy_ai, month):
        ...
        ### Computing the Delta of Temerature caused by the AI
        if direction == -1:
            delta_temperature_ai = -energy_ai
        elif direction == 1:
            delta_temperature_ai = energy_ai
        ### Updating the server's temperature when there is the AI
        self.temperature_ai += delta_intrinsic_temperature + delta_temperature_ai
        ### Updating the server's temperature when there is no AI
        ...
        # Returning the Next State, Reward and Game Over
    ...
    # Making a method that gives us at anytime the current state, the last reward and whether the Game is over
    def observe(self):
        scaled_temperature_ai = (self.temperature_ai - self.min_temperature) / (self.max_temperature - self.min_temperature)
        scaled_number_users = (self.current_number_users - self.min_users) / (self.max_users - self.min_users)
        scaled_rate_data = (self.current_rate_data - self.min_rate_data) / (self.max_rate_data - self.min_rate_data)
